void buildBlackboard2(TString p_mappingFilename="Mapping_2016.txt",
					 TString nx_inFile="data/analysis_full_area_data1_0000.root",
					 ...
					 TString padiwa_inFile_noise="data/thrScans_from_pairs_in_noise_win.root")
{
	...
	// nXYTER in win "A"
	histoName.Form("TrigEventBuilding/adcInTriggeredEventWoBaseline");
	...
	histoName.Form("TrigEventBuilding/adcInNoiseEventWoBaseline");
	...
	for (UInt_t iPixel=0; iPixel<64; iPixel++) {
		...
		outPicFilename.Form("pictures_signal_eps_2/blackboard_inWin_pixel%d.eps", iPixel);
		canv[iPixel]->SaveAs(outPicFilename);
		outPicFilename.Form("pictures_signal_png_2/blackboard_inWin_pixel%d.png", iPixel);
		canv[iPixel]->SaveAs(outPicFilename);
	}
	...
	for (UInt_t iPixel=0; iPixel<64; iPixel++) {
		...
		outPicFilename.Form("pictures_noise_eps_2/blackboard_inNoiseWin_pixel%d.eps", iPixel);
		canvNoise[iPixel]->SaveAs(outPicFilename);
		outPicFilename.Form("pictures_noise_png_2/blackboard_inNoiseWin_pixel%d.png", iPixel);
		canvNoise[iPixel]->SaveAs(outPicFilename);
	}
	...
	TFile* outFile = new TFile("Blackboard_Nov2016_2.root", "RECREATE");
